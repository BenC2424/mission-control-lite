...
async function ensureTenantFoundation() {
  const tenantTables = ['agents','tasks','task_notes','task_events','task_assignments','heartbeat_runs','heartbeat_restart_attempts','task_recovery_actions','standups','weekly_reports'];
  if (backend.mode === 'postgres') {
